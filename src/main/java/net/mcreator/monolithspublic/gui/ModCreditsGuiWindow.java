...
@OnlyIn(Dist.CLIENT)
public class ModCreditsGuiWindow extends ContainerScreen<ModCreditsGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = ModCreditsGui.guistate;

	public ModCreditsGuiWindow(ModCreditsGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
