...
package net.mcreator.monolithspublic.world.structure;
...
public class MonolithStructure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 1000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("monolithspublic", "monolith"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("monolith"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("monolithspublic:monolith"), configuredFeature);
		}
	}
